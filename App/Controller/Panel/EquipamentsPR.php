...
class EquipamentsPR extends Page
{
    ...
    public static function setExport($request)
    {
        if(isset($_POST["Export"])) {
            ...
            header('Content-Disposition: attachment; filename=indisponiveisPR.csv');

            $obEquipaments = EntityEquipaments::getEquipaments("uf = 'PR' AND NOT disp_atual = 'Disponível'", null, null, "n_terminal, ponto, n_serie, status, wo, data_chamado, email, obs, req, uf")->fetchAll();
